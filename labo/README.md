...
Laboratoire hors chaîne. Figures, pas preuves. Bibliothèque standard.
    ...
    python3 labo/aura_veillee.py      # K29–K34 aura d'une veillée = lecture des 64 feuilles sur 8 positions
    node --experimental-strip-types atelier/scripts/exporter-run.ts labo 0 labo   # export réel → labo/run_atelier.json
    node --experimental-strip-types atelier/scripts/exporter-veillee.ts 7         # veillée réelle → labo/veillee_atelier.json
