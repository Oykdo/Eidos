...
cd atelier && npm ci && npm test # 30 tests de scripts et 605 tests Eidos, vecteurs partagés avec Python
```
...
| `atelier/` | — | atelier web, moteur tactique compris (`src/lib/eidos/tactique/`) ; `npm test` lance 30 tests de scripts et 605 tests Eidos | 605 |
