...
atelier/            interface web (TanStack Start, React), rejoue la spec en TS ;
                    ...
                    scripts/banc-veillee.ts = le budget d'une run entière sous chaque règle (A17, A18, A5, A28), 45 configurations, sans signature
...
npm run banc-veillee           # le budget d'une run : 1 000 runs × 45 configurations (~50 min), le juge d'A17, d'A18 et d'A28
```
