...
cd atelier && npm ci && npm test # 30 script tests and 624 Eidos tests, vectors shared with Python
```
...
| `atelier/` | — | web atelier, tactical engine included (`src/lib/eidos/tactique/`); `npm test` runs 30 script tests and 624 Eidos tests | 624 |
