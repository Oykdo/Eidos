...
export const FR = {
  ...
  "coffreh.lede": "Un coffre par bloc, jamais par horloge de machine. Une pièce prouvée l'ouvre, le tier vient de la graine, et tout se rejoue depuis la tête publiée.",
  ...
  "coffreh.regle": "Lecture seule : rien n'est réclamé ici. {k} tiers, sac de {n} places, une pièce ouvre un coffre par bloc.",
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  "coffreh.regle": "Read-only: nothing is claimed here. {k} tiers, a {n}-place bag, one coin opens one chest per block.",
