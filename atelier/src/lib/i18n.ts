...
export const FR = {
  ...
  "envoi.destAide": "En glyphes. Les quatre derniers groupes sont la somme de contrôle : une adresse altérée est refusée avant toute signature.",
  "envoi.signe": "Signé. Le coffre a retiré ses pièces et brûlé sa clé ; le réseau ne verra rien tant que la dépense n'est pas déposée.",
  "envoi.deposer": "Déposer par issue",
  "envoi.copier": "Copier la dépense",
  "envoi.copie": "Copié.",
  "envoi.oublier": "Effacer",
  "envoi.tropLong": "Trop long pour une issue : regroupez d'abord.",
  ...
  "sous.bataille": "La dalle de l'étage, deux camps, zéro dé : chaque coup se lit avant d'être porté.",
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  "envoi.destAide": "In glyphs. The last four groups are the checksum: an altered address is refused before anything is signed.",
  "envoi.signe": "Signed. The vault has removed its coins and burned its key; the network sees nothing until the spend is deposited.",
  "envoi.deposer": "Deposit by issue",
  "envoi.copier": "Copy the spend",
  "envoi.copie": "Copied.",
  "envoi.oublier": "Dismiss",
  "envoi.tropLong": "Too long for one issue: regroup first.",
  ...
  "nav.bataille": "Battle",
  "sous.bataille": "The floor's slab, two sides, zero dice: every blow is read before it lands.",
  "tour.bataille": "Fight",
