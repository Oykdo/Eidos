...
export const FR = {
  ...
  "veillee.exportee": "Preuve exportée (eidos-veillee/2)",
  ...
  "veillee.err.tenue": "Salle tenue : un Indéchiffré la garde. Le butin attend la bataille.",
  "veillee.err.bataille": "Une bataille est ouverte : finis-la d'abord.",
  "veillee.salle.tenue": "Salle tenue par {n} Indéchiffré(s). Le butin attend : bats-toi, ou franchis.",
  "veillee.salle.libre": "Salle libre.",
  "veillee.bataille.ouverte": "Bataille en cours, tour {t} · {n} feuilles.",
  "veillee.bataille.enlisee": "La bataille s'enlise : {t} mains rendues sans issue. Tu peux franchir.",
  "veillee.bataille.aller": "Aller à la bataille",
  "veillee.bataille.sansObjet": "Aucun objet ne se bat dans ce coffre : franchis, ou prends avec une capsule.",
  "veillee.bataille.gratuit": "Un pas, rien de brûlé · {n} restantes",
  "veillee.bataille.victoire": "Victoire : la salle se lit · {n} restantes",
  "veillee.bataille.defaite": "Défaite : la salle reste tenue · {n} restantes",
  "veillee.bataille.epuise": "Arbre épuisé en pleine bataille.",
  "veillee.bataille.tombee": "{nom} est tombé et quitte le coffre",
  "veillee.bataille.abattus": "{n} abattu(s), ils ne reviennent pas",
  "veillee.bataille.finie.victoire": "Bataille gagnée au tour {t}.",
  "veillee.bataille.finie.defaite": "Bataille perdue au tour {t}.",
  "veillee.bataille.finie.epuise": "Bataille arrêtée au tour {t} : l'arbre est vide.",
  "bataille.veillee": "Bataille de la veillée : salle {i}, {n} feuilles vraies. Chaque coup en brûle une.",
  "bataille.veillee.aucune": "Aucune bataille ouverte dans la veillée. Ouvre-la depuis la page Veillée, ou ici avec tes objets.",
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  "veillee.exportee": "Proof exported (eidos-veillee/2)",
  ...
  "veillee.err.tenue": "Held room: an Undeciphered guards it. The loot waits for the battle.",
  "veillee.err.bataille": "A battle is open: finish it first.",
  "veillee.salle.tenue": "Room held by {n} Undeciphered. The loot waits: fight, or cross.",
  "veillee.salle.libre": "Free room.",
  "veillee.bataille.ouverte": "Battle in progress, turn {t} · {n} leaves.",
  "veillee.bataille.enlisee": "The battle is stuck: {t} hands passed with no outcome. You can cross.",
  "veillee.bataille.aller": "Go to the battle",
  "veillee.bataille.sansObjet": "No item in this vault can fight: cross, or take with a capsule.",
  "veillee.bataille.gratuit": "A step, nothing burned · {n} left",
  "veillee.bataille.victoire": "Victory: the room reads · {n} left",
  "veillee.bataille.defaite": "Defeat: the room stays held · {n} left",
  "veillee.bataille.epuise": "Tree exhausted mid-battle.",
  "veillee.bataille.tombee": "{nom} fell and leaves the vault",
  "veillee.bataille.abattus": "{n} slain, they do not return",
  "veillee.bataille.finie.victoire": "Battle won on turn {t}.",
  "veillee.bataille.finie.defaite": "Battle lost on turn {t}.",
  "veillee.bataille.finie.epuise": "Battle stopped on turn {t}: the tree is empty.",
  "bataille.veillee": "The vigil's battle: room {i}, {n} real leaves. Every blow burns one.",
  "bataille.veillee.aucune": "No battle open in the vigil. Open it from the Vigil page, or here with your items.",
