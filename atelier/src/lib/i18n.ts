...
export const FR = {
  ...
  "sous.signatures": "Lecture, pas un 5ᵉ glyphe",
  ...
  "guide.lede":
    "Coffre : dépenser. Journal : genèse. Témoin : une tête. Arbre : une carte. Reliques : lumen. Glyphes : 6 bits. Signes : lecture.",
  "guide.01": "Coffre",
  "guide.01p":
  ...
  "guide.07": "Signatures",
  "guide.07p": "Neuf lectures des mêmes 64. Paracelse n'ajoute pas de figure. 9 ≠ 33.",
  "guide.07b": "Voir les signatures",
  "guide.08": "Ce que ce n'est pas",
  "guide.08p": "Pas de nœud réseau, pas de fédération, pas de monnaie.",
  ...
  "sig.tria.mercure": "Mercure — l'esprit",
  "sig.tria.soufre": "Soufre — l'âme, en bas",
  "sig.choeur": "Le chœur",
  "sig.choeurLede": "D'Uranie aux étoiles jusqu'à Thalie, qui touche le sol.",
  ...
  "sig.mars": "Ce qui tranche. Trois croix.",
  "sig.soleil": "Le cercle, sans point. L'or de Satya n'est pas ☉.",
  "sig.venus": "Le miroir. Cercle, croix, cercle.",
  "sig.mercure": "Les trois figures. Psychopompe — déjà l'empilement 27.",
  "sig.lune": "Déjà dans l'alphabet. Le croissant est Luna.",
  "sig.terre": "Thalie touche le sol. Le vide, puis la croix.",
  "sig.m.uranie": "—",
  "sig.m.saturne": "plomb",
  "sig.m.jupiter": "étain",
  "sig.m.mars": "fer",
...
export const EN: { [K in keyof typeof FR]: string } = {
  ...
  "sous.signatures": "A reading, not a 5th glyph",
  ...
  "guide.h": "How to read",
  "guide.lede":
    "Vault: spend. Ledger: genesis. Witness: a tip. Tree: a map. Relics: lumen. Glyphs: 6 bits. Signs: a reading.",
  "guide.01": "Vault",
  "guide.01p":
  ...
  "guide.07": "Signatures",
  "guide.07p": "Nine readings of the same 64. Paracelsus adds no figure. 9 ≠ 33.",
  "guide.07b": "See the signatures",
  "guide.08": "What this is not",
  "guide.08p": "No network node, no federation, no money.",
  ...
  "sig.tria.mercure": "Mercury — the spirit",
  "sig.tria.soufre": "Sulfur — the soul, at the bottom",
  "sig.choeur": "The choir",
  "sig.choeurLede": "From Urania at the fixed stars down to Thalia, who touches the ground.",
  "sig.code": "stack {n} / 63",
  "sig.pas":
  ...
  "sig.mars": "That which cuts. Three crosses.",
  "sig.soleil": "The circle, no dot. Satya's gold is not ☉.",
  "sig.venus": "The mirror. Circle, cross, circle.",
  "sig.mercure": "All three figures. Psychopomp — already stack 27.",
  "sig.lune": "Already in the alphabet. The crescent is Luna.",
  "sig.terre": "Thalia touches the ground. Void, then the cross.",
  "sig.m.uranie": "—",
  "sig.m.saturne": "lead",
  "sig.m.jupiter": "tin",
  "sig.m.mars": "iron",
