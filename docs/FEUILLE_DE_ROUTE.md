...
| **A18** | 27 salles ou 9 ? | idem | **TRANCHÉ PAR LA MESURE le 2026-09-14 : 9.** À 27 salles avec une bataille par salle, aucune règle n'arrive (0 ‰, 0 ‰, 57 ‰ à 64 feuilles-morts : 26 batailles à 3,7 coups ou 1,7 mort) ; à 9, les trois arbres arrivent. Reste à l'auteur de confirmer `ETAGES_PAR_BANDE` 3 → 1 et `SAC_PLACES = DALLE_N²` (bible §6.1) |
