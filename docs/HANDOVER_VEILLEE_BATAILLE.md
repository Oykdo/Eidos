...
**Dépôt :** Oykdo/Eidos · **Rédigé le :** 2026-09-14, contre `9927508` (612 tests, 127 suites) · **Statut :** **PR 5a livrée le 2026-09-14** (le banc, §3 mesuré) ; A18 tranché par la mesure, A17 et A28 attendent l'auteur ; 5b et 6 restent à coder
...
| **A28** | la contrepartie de la permadeath : (a) une unité tombée ne compte que dans une bataille **perdue** ; (b) les captures se battent (recrutement en cours de run) ; (c) assumer des runs de deux salles | (a) d'abord — une configuration de plus au banc, sans toucher au moteur ; (b) est un chantier (les occupants capturés deviennent des unités : `SPEC_TACTIQUE.md` §5) | l'auteur, avant 5b ; (a) se mesure en une heure |
