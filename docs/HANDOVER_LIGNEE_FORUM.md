...
| **L3 — le péage** | E5 de `HANDOVER_PUITS.md` : une sortie ≥ 1/4 IONOS vers `A(lignee)` dans la transaction de tout maillon après l'origine | `lignee.ts` | trois refus | 0 tx dédiée | — (A7 tranché : obligatoire, gratuit pour l'origine) |
