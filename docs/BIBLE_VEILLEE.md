...
- **La sortie, les Indéchiffrés et « une feuille, une mort » ne sont pas codés ; les neuf salles le sont depuis le 2026-09-16.** Le code d'aujourd'hui fait 9 étapes, quatre gestes, un arbre de 64 feuilles et une feuille par coup porté (A17, tranché « un coup »). Cette bible dit ce qu'il faut construire, pas ce qui existe : la marque d'état de chaque paragraphe est la seule chose qui engage.
